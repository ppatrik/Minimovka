\documentclass[thesismargins, thesislinespacing, openright, upjsfrontpage, combineabstracts]{rnthesis}
...
\abstract{
Dôležitú rolu pri riešení kybernetických bezpečnostných incidentov zohráva adekvátna reakcia na kybernetické bezpečnostné hrozby a útoky. Významným aspektom v tomto smere predstavuje čas potrebný na spracovanie a analýzu kybernetických bezpečnostných údajov. Súčasne dohľadované a bezpečnostné systémy z tohto dôvodu vyžadujú spracovanie veľkého množstva bezpečnostných údajov v reálnom čase. 
}

\keywords{lorem ipsum, dolor, sit amet}

\abstrakt{
Cieľom práce je analyzovať dostupné bezpečnostné riešenia a porovnať ich vzhľadom na ich efektivitu a aplikovateľnosť v reálnej prevádzke. Súčasne je cieľom navrhnúť prostredie umožňujúce reprezentáciu, integráciu a analýzu bezpečnostných údajov za účelom zvládania kybernetických bezpečnostných hrozieb v reálnom čase.
}
...
%\section{Predpoveď budúceho stavu siete}

%\textcolor{red}{Detailnejsi pohlad na forecast.}
