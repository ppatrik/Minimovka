...
\textcolor{red}{doplnit podla knihy ktoru palo posle} \cite{wang2013cyber}
...
%\includepdf[pages=-]{priloha/clanok-DataCollection1.pdf}
%\includepdf[pages=-]{priloha/clanok-Profiling.pdf}
%\includepdf[pages=-]{priloha/clanok-HAIS.pdf}
